...
[x] 10. 按 Blades 的单概念颗粒度建立 `example/` demo 体系，并优先补齐 Client 侧 API。
  - 阶段进度：
    ...
    - [x] 实现极简、注册、Native、Managed Worker 和底层 Protocol Runtime 示例。
    - [x] 实现 A2A 与 Webhook 示例。
    - [x] 补齐示例总索引、根 README/CI、全量测试与 smoke test 说明，完成 Item 10 验收。
