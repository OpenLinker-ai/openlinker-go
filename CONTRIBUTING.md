...
APIs, Runtime primitives, callbacks, and A2A transports.
...
- strict Runtime protocol types and HTTP primitives
...
- Add or update tests for client behavior, callbacks, Runtime, or
  A2A transports.
